...
Sebuah sistem *database* relasional untuk mengelola operasional parkir kampus secara otomatis, dirancang menggunakan **MariaDB/MySQL** **XAMPP**
...
* **Normalisasi 3NF:** ![NORMALISASI DATA](Asset/Normalization.jpeg)
...
## 🚀 Cara Penggunaan
1. Import file [FileSQL_SMPKO](Databases/SMPKO.sql) atau [FileSQL_SMPKO_default_Base](Databases/SMPKO_default.sql) ke dalam MariaDB/MySQL PHP Admin Website.
